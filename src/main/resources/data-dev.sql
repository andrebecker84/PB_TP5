-- Dados iniciais para perfil dev (H2 em memória)
-- INSERTs simples sem ON CONFLICT — o schema é sempre recriado (create-drop)
INSERT INTO ativo_financeiro (ticker, nome, tipo, categoria, valor_investido, quantidade, data_ultima_operacao)
VALUES
